...
//out vec3 cameraPos;
out float sphereCenterToBillboardCenterDistance;
...
void main(void){
    ...
    sphereCenterToBillboardCenterDistance = sphereRadius*sphereRadius / d;
    ...
    float billboardRadius = sqrt(sphereRadius*sphereRadius - sphereCenterToBillboardCenterDistance*sphereCenterToBillboardCenterDistance);

    vec3 displacementVector = sphereCenterToBillboardCenterDistance * billboardOutwardsDirection;
